...
const ChartHeroSection: FC<THeroSectionProps> = ({ breadcrums, image, title }) => {
    return (
        <div className="relative">
            ...
            <img
                src={image.src}
                alt="img"
                className="w-full h-[300px] sm:h-[400px] md:h-[500px] lg:h-[200px] object-cover object-center"
            />
...
export default ChartHeroSection;
